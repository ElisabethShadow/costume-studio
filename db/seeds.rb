...
person1 = User.create!(
  first_name: "David", last_name: "Kloeren",
  address: "Berlin, Moabit", email: "dk@gmail.com",
  password: 111111)


person1 = User.create!(
  first_name: "Hello", last_name: "Kitty",
  address: "Dallas, Lucas Oil Stadium", email: "kitty@mail.com",
  password: 111111)


person1 = User.create!(
  first_name: "Administrator", last_name: "Admin",
  address: "Totally secret address", email: "admin@mail.com",
  password: 111111)
